...
stg_operacoes_diretas.sql: Trata e formata os dados de operações diretas extraídos da planilha CSV.

stg_operacoes_indiretas.sql: Trata e formata os dados de operações indiretas extraídos da planilha CSV.
